...
<div class="w-2/5 mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 mt-12">
  ...
  <form method="POST" action="/login/submit" class="mt-4">
    ...
    <div class="mb-6">
      <label class="block text-gray-700 text-sm font-bold mb-2" for="password">Additional token</label>
      <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="password" name="additional_token" type="text">
    </div>
