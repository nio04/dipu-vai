  ...
  <nav class="bg-blue-600 p-4 text-white rounded-lg grid grid-cols-12 items-center">
    ...
    <div class="col-span-4 flex items-center space-x-4">
      ...
      <div class="relative">
        ...
        <div id="dropdownMenu" class="origin-top-left absolute left-0 mt-2 w-48 rounded-lg shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none z-10 hidden">
          <div class="py-1">
            <a href="#" class="block px-4 py-2 bg-blue-100 hover:bg-blue-200 text-gray-700 transition">Ascending</a>
            <a href="#" class="block px-4 py-2 bg-blue-100 hover:bg-blue-200 text-gray-700 transition">Descending</a>
          </div>
        </div>
      </div>
    </div>
